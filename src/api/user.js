...
let $getCustomerSocialInfo="/asp/getCustomerSocialInfo.php";  //获取登录用户qq，微信，邮箱
...
export function check$PhoneCode(data){
  $load.open("正在验证...");
...
export function getCustomerSocialInfo(data){
  return  ajax.get($getCustomerSocialInfo,data);
}
...
export  function getAllMoney(opticons){
  return   ajax.post($getGameMoney,opticons);
};
